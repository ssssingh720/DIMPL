package dimpl.com.dimpl.networking;
...
public class RequestManager<T> {
    ...
    public static final String TESTING_SERVER = "http://www.dmipl.in/media_api/";
    public static final String LIVE_SERVER = "http://www.dmipl.in/media_api/";
...
//        http:
//52.76.121.132/get-issues/?mag_id=0&year=2015&month=1&user_id=5&token=rajendra@inkoniq.com|1446873092|dU73W1qQDCOhfQn4N0XFvp923woZeq6k1eBxyYSC5kg|93d274e078f9a404ce19dc355750c62865a7489f510ab815121bfdb38e9308d6
        ...
        return new IQListener<T>() {
            ...
            public void onResponse(T response, GsonRequest<T> request) {
                try {
                    ...
                    if (baseVO != null && !baseVO.getError()) {
                        request.getSourceListener().onAPIResponse(response, request.getApiMethodName());
                    } else {
                        ResponseError errorResponse = new ResponseError();
                        errorResponse.setErrorOccured(true);
                        errorResponse.setErrorMessage(((BaseVO) response).getMessage());
